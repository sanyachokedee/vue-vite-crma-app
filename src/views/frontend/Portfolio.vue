<template>
    <section>
        <div class="container pt-40 pb-20 mx-auto text-center">
            ...
            <router-link to="#" class="inline-block px-6 py-2 text-white bg-indigo-600 border-2 border-indigo-600 rounded-md hover:text-indigo-600 hover:bg-indigo-100">ผลงานทั้งหมด</router-link>            >
        </div> 
    </section>
</template>
